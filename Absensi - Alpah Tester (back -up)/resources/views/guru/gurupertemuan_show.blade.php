            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button id="open-popup1" class="btn btn-primary" data-pertemuan-id="{{ $model->id }}" data-kelas-id="{{ $model->kelas_id }}">Tampilkan Code QR</button>
                                        <script>
                                            document.getElementById('open-popup1').addEventListener('click', function() {
                                            var pertemuanId = this.getAttribute('data-pertemuan-id');
                                            var kelasId = this.getAttribute('data-kelas-id');
                                            var popupUrl = '/popup-tampil-qr-guru?kelas_id=' + kelasId + '&pertemuan_id=' + pertemuanId;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="absen_alpa">Alpa</label>
                                            <input type="hidden" name="kelas_id[{{ $item->siswa_id }}]" value="{{ $item->kelas_id }}">
                                            <input type="hidden" name="pertemuan_id[{{ $item->siswa_id }}]" value="{{ $model->id }}">
                                        </div>
                                    </td>
                        ...
                        {!! Form::close() !!}
                        <a href="{{ route('gurukelas.index') }}" class="btn btn-secondary mx-2 mt-2">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
